...
const fr: EmailStrings = {
  ackSubject: 'Votre demande {ref} est bien reçue — Spark loan',
  ...
  nlSubject: 'Confirmez votre inscription — Spark loan',
...
const en: EmailStrings = {
  ackSubject: 'Your request {ref} has been received — Spark loan',
  ...
  contactSubject: 'We have received your message — Spark loan',
  contactIntro: 'Thank you for writing to us. Your message has arrived and we will reply shortly.',
  simSubject: 'Your simulation — Spark loan',
  ...
  nlSubject: 'Confirm your subscription — Spark loan',
...
const de: EmailStrings = {
  ackSubject: 'Ihre Anfrage {ref} ist eingegangen — Spark loan',
  ...
  nlSubject: 'Bestätigen Sie Ihre Anmeldung — Spark loan',
...
const es: EmailStrings = {
  ackSubject: 'Su solicitud {ref} se ha recibido — Spark loan',
  ...
  ctaSite: 'Ir al sitio',
  contactSubject: 'Hemos recibido su mensaje — Spark loan',
  contactIntro: 'Gracias por escribirnos. Su mensaje ha llegado y le responderemos en breve.',
  simSubject: 'Su simulación — Spark loan',
  ...
  nlSubject: 'Confirme su suscripción — Spark loan',
...
const it: EmailStrings = {
  ackSubject: 'La tua richiesta {ref} è stata ricevuta — Spark loan',
  ...
  ctaSite: 'Vai al sito',
  contactSubject: 'Abbiamo ricevuto il tuo messaggio — Spark loan',
  contactIntro: 'Grazie per averci scritto. Il tuo messaggio è arrivato e ti risponderemo a breve.',
  simSubject: 'La tua simulazione — Spark loan',
  ...
  nlSubject: 'Conferma la tua iscrizione — Spark loan',
...
const nl: EmailStrings = {
  ackSubject: 'Uw aanvraag {ref} is ontvangen — Spark loan',
  greetingName: 'Hallo {name},',
  greeting: 'Hallo,',
  ...
  contactSubject: 'We hebben uw bericht ontvangen — Spark loan',
  contactIntro: 'Bedankt voor uw bericht. Het is goed aangekomen en we antwoorden u spoedig.',
  simSubject: 'Uw simulatie — Spark loan',
  ...
  nlSubject: 'Bevestig uw inschrijving — Spark loan',
...
const pt: EmailStrings = {
  ackSubject: 'O seu pedido {ref} foi recebido — Spark loan',
  ...
  contactSubject: 'Recebemos a sua mensagem — Spark loan',
  contactIntro: 'Obrigado por nos escrever. A sua mensagem chegou e responderemos em breve.',
  simSubject: 'A sua simulação — Spark loan',
  ...
  nlSubject: 'Confirme a sua inscrição — Spark loan',
...
const pl: EmailStrings = {
  ackSubject: 'Twój wniosek {ref} został odebrany — Spark loan',
  ...
  contactSubject: 'Otrzymaliśmy Twoją wiadomość — Spark loan',
  contactIntro: 'Dziękujemy za wiadomość. Dotarła do nas i wkrótce odpowiemy.',
  simSubject: 'Twoja symulacja — Spark loan',
  ...
  nlSubject: 'Potwierdź zapis — Spark loan',
...
const ro: EmailStrings = {
  ackSubject: 'Cererea dumneavoastră {ref} a fost primită — Spark loan',
  ...
  contactSubject: 'Am primit mesajul dumneavoastră — Spark loan',
  contactIntro: 'Vă mulțumim că ne-ați scris. Mesajul a ajuns și vă răspundem în curând.',
  simSubject: 'Simularea dumneavoastră — Spark loan',
  ...
  nlSubject: 'Confirmați abonarea — Spark loan',
...
const bg: EmailStrings = {
  ackSubject: 'Вашата заявка {ref} е получена — Spark loan',
  ...
  ctaSite: 'Към сайта',
  contactSubject: 'Получихме Вашето съобщение — Spark loan',
  contactIntro: 'Благодарим Ви, че ни писахте. Съобщението Ви пристигна и ще Ви отговорим скоро.',
  simSubject: 'Вашата симулация — Spark loan',
  ...
  nlSubject: 'Потвърдете абонамента си — Spark loan',
